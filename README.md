...
> สัปดาห์ที่ 1: ทุก endpoint คืนค่า **mock data** (เก็บใน memory) ยังไม่เชื่อมฐานข้อมูลจริง
...
>
> **โมเดล 3D:** วางไฟล์ `.glb` ใน `frontend/assets/models/` (ดูวิธีดาวน์โหลดจาก Sketchfab
> ใน [frontend/assets/models/README.md](frontend/assets/models/README.md)) แล้วหน้ารายละเอียดรุ่น
> จะแสดงโมเดล 3D หมุน 360° อัตโนมัติ — ถ้ายังไม่มีไฟล์ ระบบใช้ภาพ SVG แทน
